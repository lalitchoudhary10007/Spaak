...
package com.lalit.spaak_demo.ui.Base;
...
import com.lalit.spaak_demo.di.component.DaggerActivityComponent;
import com.lalit.spaak_demo.di.module.ActivityModule;
import com.lalit.spaak_demo.utils.CommonUtils;
import com.lalit.spaak_demo.utils.NetworkUtils;
   ...
   // private Unbinder mUnBinder;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mActivityComponent = DaggerActivityComponent.builder()
                ...
                .applicationComponent(((SpaakApp) getApplication()).getComponent())
                .build();
